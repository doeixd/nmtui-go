...
> **Note:** This is a fork of [doeixd/nmtui-go](https://github.com/doeixd/nmtui-go). All credit for the original project goes to [doeixd](https://github.com/doeixd) - without their work, this project wouldn't exist!
...
- **Go 1.21 or later:** Required to build the project from source.
...
1.  Clone the repository:
    ...
    ```bash
    git clone https://github.com/AsuraX-X/nmtui-go.git
    cd nmtui-go
    ```
